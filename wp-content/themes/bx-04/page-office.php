...
<div class="o-box o-box--transparent o-center u-bg-qua u-pb-2xl">
  ...
  <dl class="o-sidebar o-sidebar--table">
    ...
    <dt class="o-box o-box--thead c-content-l u-bg-secondary">主な業務内容</dt>
    <dd class="o-box o-box--tbody c-content-l">
      <?php echo get_service_list();?>
    </dd>
    <dt class="o-box o-box--thead c-content-l u-bg-secondary">免許・資格</dt>
    <dd class="o-box o-box--tbody c-content-l">
      <?php echo get_license_list();?>
    </dd>
  </dl>
  <div class="u-content-wrap u-block-center" id="staff">
    <h2 class="c-sec-heading u-text-center u-text-weight-b">スタッフ紹介</h2>
    <ul class="o-stack o-stack--l">
      <li class="o-sidebar">
        <div class="o-sidebar__author-pict u-block-center">
          <picture class="o-frame o-frame--square">
            <source type="image/avif"
              srcset="<?php echo get_template_directory_uri();?>/img/profile_default.avif" />
            <source type="image/webp"
              srcset="<?php echo get_template_directory_uri();?>/img/profile_default.webp" />
            <img
              src="<?php echo get_template_directory_uri();?>/img/profile_default.png"
              width="100%" height="100%" loading="lazy" decoding="async" fetchpriority="low" alt="" />
          </picture>
        </div>
        <div class="o-sidebar__author-data">
          <dl class="o-stack o-stack--s">
            <dt class="c-author-name u-block-center">
              <span class="c-display-2xs u-text-weight-b">BLUE B NOSE</span><br /><span
                class="c-content-m u-text-secondary">肩書き</span>
            </dt>
  ...
  <h2 class="c-sec-heading u-text-weight-b" id="access">アクセス</h2>
  <div class="o-sidebar">
